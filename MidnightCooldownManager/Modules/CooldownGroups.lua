...
local cdDescriptor = GCU.CreateDescriptor({
    ...
    namePrefix = "MidnightCooldownManager_CdGroup",
...
function CDM:PositionCooldownGroupFrames(groupIndex, frames)
    ...
    for i, frame in ipairs(frames) do
        ...
        local frameVName = (frameViewer == CDM:GetCooldownViewerFrame(VIEWERS.ESSENTIAL)) and VIEWERS.ESSENTIAL or VIEWERS.UTILITY
