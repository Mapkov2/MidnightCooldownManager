...
local function IsBlizzardPanelVisible()
    return CDM.IsCooldownViewerSettingsPanelVisible and CDM:IsCooldownViewerSettingsPanelVisible() or false
end
...
function CDM:SetBuffGroupsTabActive(active)
    ...
    if active then
        ...
        if self.HideBuffGroupSelectionPreview then
            self:HideBuffGroupSelectionPreview()
        end
...
local function RegisterBlizzardPanelCallbacks()
    ...
    local owner = {}
    CDM:RegisterCooldownViewerSettingsCallback("onShow", function()
        CDM:RefreshBuffGroupOverlayVisibility()
    end, owner)
    CDM:RegisterCooldownViewerSettingsCallback("onHide", function()
        CDM:RefreshBuffGroupOverlayVisibility()
    end, owner)
end
