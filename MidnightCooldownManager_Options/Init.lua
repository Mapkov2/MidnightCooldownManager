...
local function PrintProfileActionError(errCode)
    ...
    CDM.PrintError(errCode or L["Invalid profile data"])
end

local Font12 = _G["MidnightCDM_Font12"] or CreateFont("MidnightCDM_Font12")
Font12:SetFont(STANDARD_TEXT_FONT, 12, "")
if CDM_C.ApplyShadow then
    CDM_C.ApplyShadow(Font12)
end

local Font14 = _G["MidnightCDM_Font14"] or CreateFont("MidnightCDM_Font14")
Font14:SetFont(STANDARD_TEXT_FONT, 14, "")
if CDM_C.ApplyShadow then
    CDM_C.ApplyShadow(Font14)
end

local Font18 = _G["MidnightCDM_Font18"] or CreateFont("MidnightCDM_Font18")
Font18:SetFont(STANDARD_TEXT_FONT, 18, "")
if CDM_C.ApplyShadow then
    CDM_C.ApplyShadow(Font18)
end

StaticPopupDialogs["MidnightCooldownManager_COPY_URL"] = {
...
StaticPopupDialogs["MidnightCooldownManager_CONFIRM_RESET_PROFILE"] = {
...
StaticPopupDialogs["MidnightCooldownManager_CONFIRM_DELETE_PROFILE"] = {
